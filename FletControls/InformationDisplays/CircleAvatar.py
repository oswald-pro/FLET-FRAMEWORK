import flet
from flet import CircleAvatar, Icon, Stack, Text, alignment, colors, icons, WEB_BROWSER
...
def main(page):
    ...
    a5 = Stack(
        [
            CircleAvatar(
                foreground_image_url="https://afritservice.com/wp-content/uploads/2020/04/greg.jpg"
            ),
        ],
        width=40,
        height=40,
